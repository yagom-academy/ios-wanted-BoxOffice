...
final class MockMovieDetailRepository: MovieDetailRepositoryInterface {
    ...
    func fetchMovieReview(movieCode: String, completion: @escaping (Result<[MovieReview], Error>) -> Void) {
        ...
        reviews.append(MovieReview(id: UUID(), user: User(id: UUID(), nickname: "Neph"), password: "1234", rating: 5, image: UIImage(), description: "와 정말 재밌어요 길어요 길어요 와 정말 재밌어요 길어요 길어요와 정말 재밌어요 길어요 길어요"))
        for _ in 0..<20 {
            reviews.append(MovieReview(id: UUID(), user: User(id: UUID(), nickname: "Neph"), password: "1234", rating: 5, image: UIImage(), description: "와 정말 재밌어요"))
        }
...
var dummyMovieReview: MovieReview {
    return MovieReview(id: UUID(), user: User(id: UUID(), nickname: "Neph"), password: "1234", rating: 5, image: UIImage(), description: "와 정말 재밌어요")
}
