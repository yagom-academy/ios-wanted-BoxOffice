...
class SecondViewController: UIViewController {
    ...
    func setConstraints() {
        ...
        NSLayoutConstraint.activate([
            ...
            tableView.topAnchor.constraint(equalTo: viewingGradeLabel.bottomAnchor, constant: 40),
            tableView.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 20),
            tableView.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -20),
            tableView.heightAnchor.constraint(equalToConstant: 300),
            
            createReviewButton.topAnchor.constraint(equalTo: tableView.bottomAnchor, constant: 20),
...
extension SecondViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, titleForHeaderInSection section: Int) -> String? {
        var rate = 0
        ReviewList.forEach {
            rate += Int($0.starRating)
        }
        let title = "평균평점: \(String(rate / (ReviewList.count == 0 ? 1 : ReviewList.count)))점"
        return title
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        averageRate.append(Int(ReviewList[indexPath.row].starRating))
