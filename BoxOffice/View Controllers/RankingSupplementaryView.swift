...
final class RankingSupplementaryView: UICollectionReusableView {
    ...
    private func loadViewFromNib() {
        ...
        let nib = UINib(nibName: RankingSupplementaryView.reuseIdentifier, bundle: bundle)
